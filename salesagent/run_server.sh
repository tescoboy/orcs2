...
# orcs2 Server Startup Script
# This script starts the orcs2 server reliably

set -e  # Exit on any error

echo "🚀 Starting orcs2 server..."
...
echo "   - Buyer Portal: http://localhost:8000/buyer/"
echo "   - Publisher Login: http://localhost:8000/tenant/default/login"
...
python -m flask --app src.admin.app:app run --host=0.0.0.0 --port=8000 --debug

...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('status', sa.String(30), nullable=False),  # DRAFT, PENDING_APPROVAL, APPROVED, PAUSED, CANCELED, DELETED
    ...
    op.create_table(
        ...
        sa.Column('name', sa.String(255), nullable=False),
        sa.Column('status', sa.String(30), nullable=False),  # DRAFT, PENDING_APPROVAL, APPROVED, PAUSED, ARCHIVED, CANCELED
        ...
        sa.Column('delivery_indicator_type', sa.String(30), nullable=True),  # UNDER_DELIVERY, EXPECTED_DELIVERY, OVER_DELIVERY, etc.

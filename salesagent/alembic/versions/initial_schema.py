...
def upgrade() -> None:
    ...
    op.create_table('creative_formats',
    ...
    op.create_table('media_packages',
        sa.Column('media_buy_id', sa.String(100), nullable=False),
    ...
    op.create_table('creative_associations',
        sa.Column('media_buy_id', sa.String(100), nullable=False),
        sa.Column('package_id', sa.String(100), nullable=False),
        sa.Column('creative_id', sa.String(100), nullable=False),
        sa.ForeignKeyConstraint(['creative_id'], ['creatives.creative_id']),
        sa.ForeignKeyConstraint(['media_buy_id', 'package_id'], ['media_packages.media_buy_id', 'media_packages.package_id']),
